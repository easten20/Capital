    ...
    <div class="row clearfix">
        <div class="col-lg-5">
            <div class="heading-block topmargin">          
                <h1>
                    <?php
                    $home_1 = Page::findOne(['name' => 'home_1']);
                    echo $home_1->title;
                    ?>                    
                </h1>
            </div>
        ...
        <article class="portfolio-item pf-media pf-icons">
            <div class="portfolio-image">
                ...
                <div class="portfolio-overlay" data-lightbox="gallery">
                    ...
                    foreach ($item->portfoliogaleries as $v) {
                        if (!empty($v->image)) : 
                            //print_r( Yii::$app->request->BaseUrl . '/uploads/portfolio/' . $v->image); die();
                            ?>
                            <a class="center-icon" data-lightbox="gallery-item" href="<?= Url::to($v->image, true); ?>">
